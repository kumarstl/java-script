function multipleBy8(num){
    return num*8
}
multipleBy8.power=2
console.log(multipleBy8(8));
console.log(multipleBy8.power);
console.log(multipleBy8.prototype);
...
//This Means--> Jisna Bhi Bulaiya hai uska ps jyo..!!
